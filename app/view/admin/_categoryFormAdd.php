 ...
 <div id="items" class="container-fluid float-right">
        ...
        <form method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" name="ctitle" id="ctitle" placeholder="Title">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <textarea name="cdescription" id="cdescription" cols="50" rows="5"></textarea>
            ...
            <div id="buttons" class="container">
                <br>
                <button value="submit" name="csubmit" class="btn btn-primary">Save Changes</button>
